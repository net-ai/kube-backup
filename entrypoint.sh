...
RESOURCETYPES="${RESOURCETYPES:-"ingress deployment configmap svc rc ds networkpolicy statefulset storageclass cronjob limitrange crd serviceaccount pvc hpa role rolebinding destinationpolicy"}"
